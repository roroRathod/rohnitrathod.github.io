 ...
 function handleCommand(input) {
  ...
  switch (input) {
    ...
    case 'help':
      ...
      case 'Resume':
      case 'resume':
        output.innerHTML += '<p><span class="command">resume</span> <a href="https://drive.google.com/file/d/1qm5-VhnYsLhafTTT99opxQa2Zs-SytAJ/view?usp=sharing">Click Here or type in command promt</a><p>';
        window.open('https://drive.google.com/file/d/1qm5-VhnYsLhafTTT99opxQa2Zs-SytAJ/view?usp=sharing');
        break;
